# Ce code est un jeu de devinettes où l’utilisateur doit deviner un mot caché. 
# Le mot caché est un mot de la liste ‘dictionnaire’, et certains de ses caractères sont remplacés par des astérisques. 
# L’utilisateur doit entrer un mot de la même longueur, et le programme révèle les caractères correctement devinés après chaque tentative. 
# Le jeu se termine lorsque l’utilisateur devine correctement le mot entier.
...
word = random.choice(dictionnaire)  # Sélectionne un mot aléatoire de la liste 'dictionnaire'
